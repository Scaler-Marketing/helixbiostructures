...
var _videoModal = require("./modules/videoModal");
var _proteinCart = require("./modules/proteinCart");
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    (0, _contactForm.initContactForm)();
    (0, _videoModal.setVideosModal)();
});
(0, _proteinCart.setProteinStore)();
document.fonts.ready.then(()=>{
    (0, _staggerText.setStaggerText)();
    (0, _staggerHeading.setStaggerHeading)();
});

},{"./modules/setLoadingStates":"10fje","./modules/staggerHeading":"kL2X7","./modules/staggerText":"h1EYx","./modules/buttonStates":"lezKo","./modules/playVideoOnScroll":"gWHEb","./modules/menus":"drhda","./modules/setImageMasks":"4hIA7","./modules/staggerElements":"aJF8f","./modules/formSubmit":"6PCS8","./modules/contactForm":"cKgNZ","./modules/videoModal":"6wIlb","./modules/proteinCart":"bkUYA"}],"10fje":[function(require,module,exports) {
...
function setImageMasks() {
    ...
    imageMasks.forEach((el)=>{
        ...
        if (type === "diamond") setDiamondMask(el);
        if (type === "hexagon") setHexagonMask(el);
        if (type === "bubbles") setBubblesMask(el);
    });
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cKgNZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initContactForm", ()=>initContactForm);
function initContactForm() {
    const formWrapper = document.querySelector(".contact-form_wrapper"), formTrigger = document.querySelectorAll("[data-contact-open]");
    if (!formWrapper || !formTrigger) return;
    const form = formWrapper.querySelector(".contact-form_inner"), formClose = formWrapper.querySelector(".contact-form_close"), formCloseCircles = formClose.querySelectorAll("circle"), backdrop = formWrapper.querySelector(".contact-form_backdrop");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6wIlb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setVideosModal", ()=>setVideosModal);
function setVideosModal() {
...
function setVideoModal(modal) {
    const backdrop = modal.querySelector(".video-player-full_modal-backdrop"), videoPlayer = modal.querySelector(".video-player-full_modal-inner"), videoClose = modal.querySelector(".video-player-full_modal-close");
    gsap.set(modal, {
        visibility: "hidden",
        backdropFilter: "blur(0px)"
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bkUYA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setProteinStore", ()=>setProteinStore);
var _getHeight = require("./getHeight");
function getStoreItems() {
    const purchaseStore = localStorage.getItem("helix_protein_purchase_list");
    if (purchaseStore) return JSON.parse(purchaseStore);
    else {
        setStoreItems([]);
        return [];
    }
...
function initPurchaseForm(store) {
    const formTrigger = document.querySelector(".purchase-form_trigger"), formTriggerHeight = (0, _getHeight.getElementHeightInRem)(formTrigger), formClose = document.querySelector(".purchase-form_close"), formCloseCircles = formClose.querySelectorAll("circle"), form = document.querySelector(".purchase-form"), formInner = document.querySelector(".purchase-form_inner"), backdrop = document.querySelector(".purchase-form_backdrop");
    gsap.set(form, {
        visibility: "hidden",
        opacity: 0
    });
    gsap.set(formInner, {
        height: `${formTriggerHeight}rem`
    });
    gsap.set(backdrop, {
        opacity: 0,
        backdropFilter: "blur(0px)"
    ...
    document.addEventListener("alpine:init", ()=>{
        Alpine.store("purchaseForm", {
            ...
            addItem (name, quantity) {
                ...
                if (itemIndex === -1) this.list.push({
                    name,
                    quantity: Number(quantity)
                });
                else this.list[itemIndex].quantity += Number(quantity);
            ...
            addQuantity (item) {
                ...
                this.list[itemIndex].quantity = parseFloat(Number(this.list[itemIndex].quantity) + 0.1).toFixed(1);
                setStoreItems(this.list);
            },
            subtractQuantity (item) {
                const itemIndex = this.list.findIndex((el)=>el.name === item.name);
                if (itemIndex === -1) return;
                if (this.list[itemIndex].quantity > 0) this.list[itemIndex].quantity = parseFloat(Number(this.list[itemIndex].quantity) - 0.1).toFixed(1);
                setStoreItems(this.list);
            },
            purchaseListFormatted () {
                return this.list.map((item)=>`${item.name} (${item.quantity}mg)`).join("; \n");
            },
            totalItems () {
                if (this.list.length === 1) return `${this.list.length} item`;
...
},{"./getHeight":"1eyAq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7vXoQ","9qcUd"], "9qcUd", "parcelRequire5744")
