...
})({"hvMaF":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "51bb909d47a7d47c";
"use strict";
...
},{}],"jLi9N":[function(require,module,exports) {
...
function initBulletLists() {
    ...
    if (!items) return;
    items.forEach((item)=>{
        const bullet = item.querySelector(".bullet-list_icon"), text = item.querySelector("p");
        gsap.set(bullet, {
            scale: 0
        });
        ...
        (0, _setLinesWrapper.setLinesWrapper)(lines.lines, ()=>{
...
},{}]},["hvMaF","jLi9N"], "jLi9N", "parcelRequire5744")
