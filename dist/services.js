...
var _slider = require("./services/slider");
var _services = require("./services/services");
document.fonts.ready.then(()=>{
    (0, _slider.initServicesSlider)();
    (0, _services.initServicesSectionScroll)();
});

},{"./services/slider":"f9zni","./services/services":"ksnDf"}],"f9zni":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initServicesSlider", ()=>initServicesSlider);
...
},{}],"ksnDf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initServicesSectionScroll", ()=>initServicesSectionScroll);
var _createSVGGrid = require("../modules/createSVGGrid");
var _setLinesWrapper = require("../modules/setLinesWrapper");
function initServicesSectionScroll() {
    const wrapper = document.querySelector(".section.list-scroll"), sections = wrapper.querySelectorAll(".section-list-scroll_inner"), spacers = wrapper.querySelectorAll(".section-anchor"), anchorLinks = wrapper.querySelectorAll(".section-nav-item"), numbers = wrapper.querySelector(".scroll-list-numbers-inner"), numbersLength = numbers ? numbers.querySelectorAll("div").length : null;
    if (!sections) return;
    let currentIndex = 0;
    ...
    sections.forEach((section, i)=>{
        ...
        const title = section.querySelector(".section-scroll-title > *"), descriptionEl = section.querySelector(".section-scroll-description"), descriptionType = descriptionEl.classList.contains("is-masked") ? "html" : "text";
        let anchorLink;
        if (anchorLinks) anchorLink = id ? wrapper.querySelector(`.section-nav-item[data-target="${id}"]`) : anchorLinks[i];
        let titleMaskEl, description;
        if (title && descriptionType !== "html") titleMaskEl = (0, _createSVGGrid.createSVGGrid)(title, 10);
        if (descriptionType === "html") description = (0, _createSVGGrid.createSVGGrid)(descriptionEl.querySelector("div"), 10);
        else {
...
function setListSectionScroll(settings) {
    const { trigger, isFirst, isLast, titleMaskEl, description, anchorLink, onComplete } = settings;
    ...
    if (!isFirst) {
        if (titleMaskEl) tl.to(squaresTitle, {
            opacity: 1,
            duration: 0.01,
            stagger: {
                from: "random",
        ...
        if (description.type === "html") tl.to(squaresDescription, {
            opacity: 1,
            duration: 0.005,
            stagger: {
                from: "random",
        ...
        if (description.type === "text" && description.el) tl.to(description.el, {
            yPercent: 0,
            stagger: 0.02,
            duration: 0.5,
            ease: "power4.inOut"
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hPUmk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["axRbR","k1cWz"], "k1cWz", "parcelRequire5744")
