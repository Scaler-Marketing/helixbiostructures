...
function updateImageSequenceCount(file) {
    ...
    if (allImagesCount === 0) setTimeout(function() {
        lenis.resize();
    }, 500);
}
...
function initCanvas(section, canvas, prefix, suffix, frames, device) {
    ...
    for(var i = 0; i < frameCount; i++){
        ...
        img.onload = function() {
            ...
            // if (allImagesCount === 0) {
            if (allImagesCount === totalCount - 1) initCanvasAnimations(section, images, context, canvas);
        };
...
},{}]},["4F2IG","kXJeY"], "kXJeY", "parcelRequire5744")
