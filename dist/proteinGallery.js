...
})({"lfqQR":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "2f8d58f4906958ec";
"use strict";
...
},{}],"kNfU2":[function(require,module,exports) {
...
function initProteinGallery(store) {
    ...
    items.forEach((item, i)=>{
        ...
        minus.addEventListener("click", (e)=>{
            e.preventDefault();
            if (quantity.value > 0) quantity.value -= 0.1;
        });
    });
}
...
document.addEventListener("alpine:init", ()=>{
    Alpine.store("purchaseForm", {
        ...
        subtractQuantity (item) {
            const itemIndex = this.list.findIndex((el)=>el.name === item.name);
            if (itemIndex === -1) return;
            if (this.list[itemIndex].quantity > 0) this.list[itemIndex].quantity--;
        },
...
},{"./modules/getHeight":"1eyAq"}],"1eyAq":[function(require,module,exports) {
/**
...
},{}]},["lfqQR","kNfU2"], "kNfU2", "parcelRequire5744")
