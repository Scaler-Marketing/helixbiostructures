...
},{"./home/homeIntroText":"5u6HL","./home/services":"8ztf4","./home/newsSlider":"e191i"}],"5u6HL":[function(require,module,exports) {
...
function setHomeIntroText() {
    ...
    (0, _createSVGGrid.createSVGGrid)(document.querySelector(".section.home-hero canvas"), 20);
...
},{}],"8Spds":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8ztf4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initSectionScroll() {
    const wrapper = document.querySelector(".section.list-scroll"), sections = wrapper.querySelectorAll(".section-list-scroll_inner");
    if (!sections) return;
    sections.forEach((section, i)=>{
        const id = section.dataset.section, trigger = document.getElementById(id), title = section.querySelector("h2"), description = section.querySelector("p"), button = section.querySelector(".button"), videoBg = wrapper.querySelector(`.section-scroll-video-bg[data-section-id="${id}"] video`), anchorLink = wrapper.querySelector(`.section-nav-item[data-target="${id}"]`);
        let descriptionLines;
        const maskEl = (0, _createSVGGrid.createSVGGrid)(title, 10);
        const maskVideo = (0, _createSVGGrid.createSVGGrid)(videoBg, 10);
        // Split all words on the brand core section
        ...
        let scrollTimeout;
        setListSectionScroll(trigger, i === 0, i === sections.length - 1, maskEl, maskVideo, descriptionLines, button, anchorLink, scrollTimeout);
    });
}
function setListSectionScroll(trigger, isFirst, isLast, titleMaskEl, maskVideo, descriptionLines, button, anchorLink, scrollTimeout) {
    ...
    tlVideo.to(squaresVideo, {
        ...
        ease: "power4.out"
    }).addPause().addLabel("out").to(squaresVideo, {
        opacity: 0,
        duration: 0.005,
        overwrite: "auto",
        stagger: {
...
},{"../modules/createSVGGrid":"8Spds","../modules/setLinesWrapper":"hPUmk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e191i":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
